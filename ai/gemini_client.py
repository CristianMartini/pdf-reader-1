...
def rewrite_content_to_style(raw_content: str, model: str = "gemini-2.5-flash") -> str:
    ...
    full_prompt = (
        ...
        "no texto, para que o usuário possa inserir imagens depois. ATENÇÃO: NUNCA gere qualquer legenda em itálico ou texto "
        "descritivo embaixo das tags [IMG:...]. Deixe a tag de imagem isolada em sua própria linha.\n\n"
